  ...
  def footer
    footer class: "flex flex-col justify-between items-center mt-16 px-6 py-2 bg-white dark:bg-gray-800 sm:flex-row" do
      ...
      div class: "container" do
        div class: "float-right items-center" do
          a href: "https://wallet.nimiq.com/nimiq:NQ6649HXM9EQVDV2SQQKKXBNTXSJT8L0A7GY", target: "_blank", class: "inline-block self-end mr-4" do
            img src: "https://www.nimiq.com/accept-donations/img/donationBtnImg/red-small.svg"
          end
          a href: "https://ko-fi.com/G2G83QD5W", target: "_blank", class: "inline-block self-top" do
            img alt: "Buy Me a Coffee at ko-fi.com", border: "0", height: "36", src: "https://cdn.ko-fi.com/cdn/kofi5.png?v=2", style: "border:0px;height:36px;"
          end
        end
      end
    end
