      ...
      div class: "mx-auto px-4 py-3 bg-white dark:bg-gray-800 shadow-md rounded-md" do
        div class: "mt-2" do
          div class: "grid grid-flow-row auto-rows-max gap-4" do
            form_for Admin::Users::Update.with(current_user.id), multipart: true do
              ...
              div class: "flex justify-end mt-6" do
                submit "Update",  data_disable_with: "Replying...", class: "bg-gray-700 text-white py-2 px-4 rounded hover:bg-gray-500 hover:text-white focus:outline-none focus:bg-gray-500 focus:text-white"
              end
            end
          end
        end
