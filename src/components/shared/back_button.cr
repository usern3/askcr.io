class Shared::BackButton < BaseComponent
  ...
  def render
    a href: "javascript:window.history.back();", class: "inline-flex items-center py-2 px-4 mt-4 bg-gray-700 text-white rounded hover:bg-gray-600 focus:outline-none float-right", type: "button" do
